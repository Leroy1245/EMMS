...
namespace EMMS.Models
{
    public class Terminal
    {
        ...
        [DisplayName("采集终端所属用户ID")]
        public int TerminalUserID { get; set; }

        [DisplayName("采集终端IP")]
        public string TerminalIP { get; set; }

        [DisplayName("采集终端连接状态")]
        public int? TerminalConnect { get; set; }

        [DisplayName("采集终端电压")]
        public double? TerminalVotal { get; set; }
        ...
        public List<EMdata> Emdatas { get; set; }

        [ForeignKey("AlarmTermID")]
